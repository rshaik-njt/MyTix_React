...
class PromoUserProfileComponent extends React.Component {
    constructor(props) {
        super(props);
    ...
    validate(){
        ...
        this.ValidationService.validateForm('updatePromoAccount', request).then(result => {
    ...
    confirmUpdateUserProfile() {
        ...
        this.ValidationService.validateForm('updatePromoAccount', request).then(result => {
            ...
            if (this.state.validateResponse.isValid) {
                //if(this.state.userProfile_newPassword === '') {
                    this.PromotionsService.updateUserProfile(request).then(response => {
    ...
    render() {
        ...
        return (
            <div id="promo-userProfile">
              ...
              >
                <div className="mt-n2">
                    <div className="col-md-12 container mt-2 pb-4">
                        ...
                        <div className="form-group col-12">
                                ...
                                <div className="">
                                    <div className="input-group">
                                        ...
                                        value={this.state.userProfile_currentPassword} onChange={this.updateEditProfile} onBlur={this.onBlur}/>
                                    </div>
                        ...
                        <div className="form-group">
                            ...
                            <div className="cols-sm-6">
                                <div className="input-group">
                                    <input type="password" className="form-control App" name="userProfile_currentPassword" 
                                    id="userProfile_currentPassword" placeholder='Current Password' 
                                    value={this.state.userProfile_currentPassword} onChange={this.updateEditPassword}/>
                                </div>
                                {this.state.validateResponse.currentPassword_error === 'required' ?
                                    <span className="form_error"> {t('label_label.currentPasswordRequired')} </span> : null}
                                {this.state.validateResponse.currentPassword_error === 'minLength' ?
                            ...
                            <div className="form-group">
                                ...
                                <div className="cols-sm-6">
                                    ...
                                    <OverlayTrigger
                                        ...
                                        value={this.state.userProfile_newPassword} onChange={this.updateEditPassword}/>
                                    </OverlayTrigger>
                                    </div>
                            ...
                            <div className="form-group">
                                ...
                                <div className="cols-sm-6">
                                    <div className="input-group">
                                        ...
                                        value={this.state.userProfile_confirmPassword} onChange={this.updateEditPassword}/>
                                    </div>
...
export default withTranslation()(PromoUserProfileComponent);